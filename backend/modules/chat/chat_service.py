...
from .schemas.chat_model import (
    ChatSystemModel,
    ChatUserModel,
    ChatSystemModelInDB,
    ChatUserModelInDB,
...
class ChatService:
    ...
    async def create_chat(
        self, chat: Union[ChatSystemModel, ChatUserModel]
    ) -> Union[ChatSystemModelInDB, ChatUserModelInDB]:
        result = await collection.insert_one(chat.model_dump())
    ...
    async def get_all_chats(
        self,
    ) -> list[Union[ChatSystemModelInDB, ChatUserModelInDB]]:
